package com.te.zealhr.auth.config;
...
public class AppConfig extends BaseConfigController {
	...
	public UserDetailsService userDetailsService() {
		return username -> 
			employeeLoginInfoRepository
				.findByEmailIdAndEmployeePersonalInfoIsActiveTrueAndEmployeePersonalInfoCompanyInfoIsActiveTrueAndEmployeePersonalInfoCompanyInfoCompanyCode(
				...
				.orElseThrow(() -> new UsernameNotFoundException(
						"The Company Code or Email Id Is Incorrect"));
	}
