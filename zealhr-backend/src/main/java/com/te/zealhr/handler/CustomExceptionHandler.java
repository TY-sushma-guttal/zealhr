...
import com.te.zealhr.exception.AdvanceSalaryNotAppliedException;
import com.te.zealhr.exception.ArrayEmptyException;
...
import com.te.zealhr.exception.EmployeeTimeSheetCannottEditedException;
import com.te.zealhr.exception.EventCannotBeEditedException;
import com.te.zealhr.exception.EventDetailsNotFoundException;
import com.te.zealhr.exception.EventNotFoundException;
import com.te.zealhr.exception.FailedToUploadException;
import com.te.zealhr.exception.FileSupportException;
...
import com.te.zealhr.exception.PaymentFailedException;
import com.te.zealhr.exception.PermissionDeniedException;
import com.te.zealhr.exception.ReimbursementNotAppliedException;
import com.te.zealhr.exception.ReportingIdNotFoundException;
import com.te.zealhr.exception.ScheduleInterviewDetailsNotFound;
import com.te.zealhr.exception.SoftwareAlreadyAvailableException;
import com.te.zealhr.exception.StatusNotAvailableException;
import com.te.zealhr.exception.TaskIdNotFoundException;
import com.te.zealhr.exception.TerminalIdNotFoundException;
import com.te.zealhr.exception.UserNotFoundException;
import com.te.zealhr.exception.account.CustomExceptionForAccount;
import com.te.zealhr.exception.account.ProductTypeNotAvailableException;
import com.te.zealhr.exception.account.SubjectNotUniqueException;
...
import com.te.zealhr.exception.admin.CategoryChildPresentException;
import com.te.zealhr.exception.admin.CompanyNotFound;
import com.te.zealhr.exception.admin.DesignationCannotUpdate;
import com.te.zealhr.exception.admin.DuplicateColorException;
import com.te.zealhr.exception.admin.DuplicateCompanyStockCategoriesNameException;
import com.te.zealhr.exception.admin.DuplicateEmployeeIdException;
import com.te.zealhr.exception.admin.DuplicateExpenseException;
import com.te.zealhr.exception.admin.DuplicateLeadException;
import com.te.zealhr.exception.admin.DuplicateLeadNameException;
import com.te.zealhr.exception.admin.DuplicateShiftNameException;
import com.te.zealhr.exception.admin.DuplicateStockGroupNameException;
import com.te.zealhr.exception.admin.DuplicateStockUnitSymbolException;
import com.te.zealhr.exception.admin.DuplicateofficialEmailIdException;
import com.te.zealhr.exception.admin.ExpenseNotUpdatedException;
import com.te.zealhr.exception.admin.HolidayNotFoundException;
import com.te.zealhr.exception.admin.IsSubmittedException;
import com.te.zealhr.exception.admin.LeadNotUpdatedException;
import com.te.zealhr.exception.admin.LevelsOfApprovalAlreadyExistException;
import com.te.zealhr.exception.admin.NoCompanyPresentException;
import com.te.zealhr.exception.admin.NoDataPresentException;
import com.te.zealhr.exception.admin.NoDeleteWorkWeekRuleException;
...
import com.te.zealhr.exception.admin.NoPayrollAvailableException;
import com.te.zealhr.exception.admin.NoPersonalInfoException;
import com.te.zealhr.exception.admin.NoTicketFoundException;
import com.te.zealhr.exception.admin.NoWorkWeekRuleException;
import com.te.zealhr.exception.admin.PayrollDeductionTitleSameException;
import com.te.zealhr.exception.admin.PayrollEarningSalaryComponentSameException;
import com.te.zealhr.exception.admin.RuleNameDefaultException;
import com.te.zealhr.exception.admin.RuleNameExitException;
import com.te.zealhr.exception.admin.RuleNameSameException;
import com.te.zealhr.exception.admin.StockCategoryNotFoundException;
import com.te.zealhr.exception.admin.StockGroupNotFound;
import com.te.zealhr.exception.admin.StockUnitNotFoundException;
import com.te.zealhr.exception.admin.WorkWeekAssociateWithEmpException;
import com.te.zealhr.exception.admin.WorkWeekRuleNotFoundException;
import com.te.zealhr.exception.admindept.CompanyPCLaptopDetailsAlreadyPresentException;
import com.te.zealhr.exception.admindept.CompanyPCLaptopDetailsNotFoundException;
import com.te.zealhr.exception.admindept.DuplicateProductNameException;
import com.te.zealhr.exception.admindept.EmployeeListNotFoundException;
import com.te.zealhr.exception.admindept.InOutNotSelectedException;
import com.te.zealhr.exception.admindept.NoHardwarePresentException;
import com.te.zealhr.exception.admindept.PurchaseIdNotPresentException;
import com.te.zealhr.exception.admindept.PurchaseOrderDoesNotExistsException;
import com.te.zealhr.exception.admindept.PurchaseOrderItemNotFoundException;
import com.te.zealhr.exception.admindept.SalesOrderDoesNotExistsException;
import com.te.zealhr.exception.admindept.SalesOrderItemNotFoundException;
...
import com.te.zealhr.exception.employee.MessagingException;
import com.te.zealhr.exception.employee.OTPNotFoundExpireException;
import com.te.zealhr.exception.employee.PushNotificationException;
import com.te.zealhr.exception.helpandsupport.EmployeeNotActiveException;
import com.te.zealhr.exception.helpandsupport.TicketAlreadyRaisedException;
import com.te.zealhr.exception.helpandsupport.WrongAttachmentFileException;
...
import com.te.zealhr.exception.project.EmployeeAlreadyMappedToProjectException;
import com.te.zealhr.exception.sales.CompanyNamePresentException;
import com.te.zealhr.exception.sales.DealAssociatedWithProjectException;
import com.te.zealhr.exception.sales.NoClientPresentException;
import com.te.zealhr.exception.sales.NoContactPersonPresentException;
import com.te.zealhr.exception.sales.NoDealPresentException;
import com.te.zealhr.exception.sales.NoLeadCategoryPresentException;
import com.te.zealhr.exception.sales.NoLeadPresentException;
import com.te.zealhr.exception.tally.TallySaasException;
import com.te.zealhr.response.ErrorResponse;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(value = com.te.zealhr.exception.employee.DataNotFoundException.class)
	public ResponseEntity<SuccessResponse> customDataNotFoundException(
			com.te.zealhr.exception.employee.DataNotFoundException exception) {
		return new ResponseEntity<>(new SuccessResponse(true, exception.getMessage(), null), HttpStatus.BAD_REQUEST);
	}
...
//	}
	...
	@ExceptionHandler(value = com.te.zealhr.exception.sales.NoClientPresentException.class)
