...
import static com.te.zealhr.common.admin.CompanyHolidayDetailsConstants.COUNTS_OF_HOLIDAY_IN_THE_YEAR;
import static com.te.zealhr.common.admin.CompanyHolidayDetailsConstants.FETCH_ALL_HOLIDAYS_OF_THE_YEAR;
import static com.te.zealhr.common.admin.CompanyHolidayDetailsConstants.FETCH_HOLIDAY_DETAIL_SUCCESSFULLY;
...
import com.te.zealhr.service.admin.CompanyHolidayDetailsService;
...
public class CompanyHolidayDetailsController extends BaseConfigController {
	...
	@PostMapping("company-holidays")
	public ResponseEntity<SuccessResponse> getAllHolidayPerYear(@RequestBody CanlenderRequestDTO calCanlenderRequestDTO) {

		return ResponseEntity
				.status(HttpStatus.OK).body(
						SuccessResponse
								.builder().error(Boolean.FALSE).message(FETCH_ALL_HOLIDAYS_OF_THE_YEAR).data(companyHolidayDetailsService
										.getAllHolidayPerYear(getCompanyId(), calCanlenderRequestDTO))
								.build());
	}
