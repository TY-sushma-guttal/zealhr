...
import static com.te.zealhr.common.hr.HrConstants.EMPLOYEE_REVISE_SALARY_SUCCESSFULLY_UPDATED;
...
import com.te.zealhr.service.hr.NotificationReviseSalaryService;
@CrossOrigin(origins = "*")
@RestController
