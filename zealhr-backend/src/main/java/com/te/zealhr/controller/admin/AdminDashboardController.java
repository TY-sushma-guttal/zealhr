...
import com.te.zealhr.service.admin.AdminDashboardService;
import com.te.zealhr.service.it.mongo.ITTicketsService;
...
//		log.info("update ticket history details of question and answer aganist employeeInfo id");
		return ResponseEntity.status(HttpStatus.OK)
				.body(SuccessResponse.builder().error(false).message("Update Tickets")
						.data(dashboardService.getQuestionAndAnswer(updateTicketDTO, getCompanyId()))
						.build());
	}
