...
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "employeeInfoId")
public class EmployeePersonalInfo extends Audit implements Serializable {
	...
	@Column(name = "epi_picture_url")
	private String pictureURL;
	
	@Column(name = "epi_model_number")
	...
	@JoinTable(name = "fa_discussion_attendees_details", joinColumns = {
			@JoinColumn(name = "dad_attendees_id") }, inverseJoinColumns = { @JoinColumn(name = "dad_duscussion_id") })
	private List<EmployeeResignationDiscussion> employeeResignationDiscussionList;

	@ManyToMany(cascade = { CascadeType.ALL })
	@JoinTable(name = "fa_meeting_attendees_details", joinColumns = {
			@JoinColumn(name = "ma_attendees_id") }, inverseJoinColumns = { @JoinColumn(name = "ma_meeting_id") })
	private List<ApprisalMeetingInfo> apprisalMeetingInfoList;

	@ManyToMany(cascade = CascadeType.ALL)
	@JoinTable(name = "fa_employee_project_details", joinColumns = {
			@JoinColumn(name = "cpd_employee_info_id") }, inverseJoinColumns = { @JoinColumn(name = "cpd_project_id") })
	...
	@OneToMany(fetch = FetchType.LAZY, cascade = CascadeType.ALL, mappedBy = "employeePersonalInfo")
	private List<EmployeeRegularizationDetails> employeeRegularizationDetailList;
}
