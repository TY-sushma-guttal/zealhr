...
import com.te.zealhr.entity.admindept.CompanySoftwareDetails;
...
import com.te.zealhr.util.MapOfMapToStringConverter;
...
public class CompanyInfo extends Audit implements Serializable {
	...
	@OneToMany(fetch = FetchType.LAZY, cascade = CascadeType.ALL, mappedBy = "companyInfo")
	private List<CompanyDepartmentDetails> companyDepartmentDetailsList;
	
	@OneToMany(fetch = FetchType.LAZY, cascade = CascadeType.ALL, mappedBy = "companyInfo")
	private List<AnnouncementDetails> announcementList;
	
	@OneToMany(fetch = FetchType.LAZY, cascade = CascadeType.ALL, mappedBy = "companyInfo")
	private List<JobRequirementDetails> jobRequirementDetailsList;
