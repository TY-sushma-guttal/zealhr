					...
					return optional
							...
							.map(r -> {
								...
								if (employeeAdvanceSalary.getEmployeePersonalInfo().getExpoToken() != null) {
									pushNotificationService.pushMessage("zealhr","Advance salary request for the amount "+employeeAdvanceSalary.getAmount()+" is Rejected by Reporting Manager",
							...
							.orElseGet(() -> optional.filter(
									...
									.map(a -> {
										...
										if (employeeAdvanceSalary.getEmployeePersonalInfo().getExpoToken() != null) {
											pushNotificationService.pushMessage("zealhr","Advance salary request for the amount "+employeeAdvanceSalary.getAmount()+" is Approved by Reporting Manager",
													employeeAdvanceSalary.getEmployeePersonalInfo().getExpoToken());
											}
