...
import com.te.zealhr.dto.sales.EmployeeBirthdayDTO;
import com.te.zealhr.dto.sales.EmployeePerformanceDTO;
		...
		return employeePersonalInfoRepository.findByEmployeeInfoIdAndCompanyInfoIsActiveTrue(employeeInfoIdTo)
				.map(emp -> {
					...
					MailDto mailDto = MailDto.builder()
							.subject("Happy Birthday " + emp.getFirstName())
							.body("Hi " + emp.getFirstName() + " ," + "\r\n" + "\r\n"
