package com.te.zealhr.service.it.mongo;
...
import com.te.zealhr.dto.it.mongo.ITTicketsDTO;
import com.te.zealhr.dto.it.mongo.UpdateITTicketDTO;
...
import com.te.zealhr.exception.it.ITTicketsDetailsNotFoundException;
	...
	public List<CompanyTicketDto> getTicketsHardwareAllocatedDetails(Long companyId, Long employeeInfoId) {
		...
		List<CompanyTicketDto> collect = comapanyItTickets.stream()
				...
				.map(x -> {
					...
					companyTicketDto.setTicketOwner(employeeInfo.getFirstName());
...
//					}
	...
	public ITTicketsDTO getTicketsHardwareAllocatedDetailsAndHistory(Long companyId, String id, Long employeeInfoId) {
		...
		itTicketsDTO.setEmployeeName(employeePersonalInfo.getFirstName());
		itTicketsDTO.setTicketOwner(employeePersonalInfo.getFirstName());
